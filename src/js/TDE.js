 ...
 */
TD.extensions.add = (extension, enable, init) => {
 ...
 */
TD.extensions.remove = (extensionName) => {
 ...
 */
TD.extensions.getExtension = (extensionName) => {
 ...
 * @returns {array}
 */
TD.extensions.getAllInitialized = () => {
 ...
 */
TD.extensions.enable = (extensionName, init) => {
 ...
 */
TD.extensions.checkDependencies = (extensionName) => {
	let extension = TD.extensions.getExtension(extensionName);
 ...
 */
TD.extensions.checkConflicts = (extensionName) => {
	let extension = TD.extensions.getExtension(extensionName);
	...
	let extensionConflictStatus = extension.conflicts.some((conflict) =>
		TD.extensions.isEnabled(conflict)
	);
 ...
 */
TD.extensions.isEnabled = (extensionName) => {
 ...
 */
TD.extensions.isInitialized = (extensionName) => {
 ...
 */
TD.extensions.resolveDependencyGraph = () => {
	let sorted = [];
	let visited = {};
 ...
 */
TD.extensions.reorderEnabledExtensions = (enabledExtensions) => {
	let extensionOrder = TD.extensions.resolveDependencyGraph();
